...
public class Notification implements Serializable {
	...
	public String toString() {
            return String.format("[id: %s: %s] to: %s; cc: %s; subject: %s; message: %s", this.getMessageId(), this.getStatus(), this.getToAddress(), this.getCcAddress(), this.getSubject(), this.getMessage());
	}
}