...
import org.patomtz.restfulws.utm.form.NotificationForm;
import org.patomtz.restfulws.utm.model.Link;
import org.patomtz.restfulws.utm.model.NotificationLinkListResource;
...
public class NotificationRest {
	...
	public ResponseEntity<?> showOptions() {
            ...
            methods.put(HttpMethod.GET, "Lista las notificaciones generadas.");
            methods.put(HttpMethod.OPTIONS, "Documentacion.");
            methods.put(HttpMethod.POST, "Genera notificacion");
