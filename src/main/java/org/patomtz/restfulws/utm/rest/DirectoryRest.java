...
import org.patomtz.restfulws.utm.model.File;
import org.patomtz.restfulws.utm.model.FileLinkListResource;
...
public class DirectoryRest {
	...
	public ResponseEntity<?> showOptions() {
            ...
            methods.put(HttpMethod.GET, "Lista los archivos en el directorio.");
	...
	@RequestMapping(value = "directory", params = {"dir"}, method = RequestMethod.GET, produces = { "application/xml", "text/xml" })
	@ResponseBody
	@ResponseStatus(HttpStatus.OK)
